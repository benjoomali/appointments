...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { description: @calendar.description, name: @calendar.name, user_id: @calendar.user_id } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { description: @calendar.description, name: @calendar.name, user_id: @calendar.user_id } }
